...
// Reference to BBS: BambuStudio/src/libslic3r/PrintConfig.hpp L676
...
extern void update_static_print_config_from_dynamic(ConfigBase& config, const DynamicPrintConfig& src_config, const std::vector<int>& variant_index, std::set<std::string>& key_set, int stride = 1);
