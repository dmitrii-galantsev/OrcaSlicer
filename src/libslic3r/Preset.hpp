...
//        assert(opt != nullptr);
    ...
    std::string get_printer_type(PresetBundle *preset_bundle) const; // get edited preset type
    std::string get_current_printer_type(PresetBundle *preset_bundle) const; // get current preset type
