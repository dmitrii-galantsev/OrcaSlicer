...
{
    m_variant_overrides.apply_to_config(*this, variant_index, keys);
...
{
    m_variant_overrides.expand_to_vectors(*this);
}

void DynamicPrintConfig::compress_vectors_to_variant_overrides(int active_variant_index)
{
    m_variant_overrides.compress_from_vectors(*this, active_variant_index);
    m_active_variant_index = active_variant_index;
}

void DynamicPrintConfig::dump_variant_overrides_to_stderr(const std::string& prefix) const
{
    m_variant_overrides.dump(prefix);
}
