...
// Orca-only wrapper: invokes manuallySetNozzleCount for both extruders.
inline void manuallySetAllNozzleCounts() { manuallySetNozzleCount(0); manuallySetNozzleCount(1); }
